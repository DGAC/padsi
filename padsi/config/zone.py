...
class Zone:
    ...
    def get_option(self, option: ZoneOptionType) -> ZoneOption:
        ...
        _default = {
            ...
            ZoneOptionType.MASS_STORAGE: BoolOption(ZoneOptionType.MASS_STORAGE, False),
            ZoneOptionType.MULTIMEDIA: BoolOption(ZoneOptionType.MULTIMEDIA, False),
            ZoneOptionType.PULSE_AUDIO: BoolOption(ZoneOptionType.PULSE_AUDIO, False),
